...
from _tfds_data_processing_c4_mlperf import make_c4_mlperf_iterator
...
def create_data_iterator(config, mesh, add_bos=True, add_eos=True):
    if config.dataset_type == "synthetic":
        ...
        assert (
            False
        ), f"Unknown dataset_type {config.dataset_type}, dataset_type must be synthetic, tfds, grain, hf or c4_mlperf"
