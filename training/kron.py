...
def scale_by_kron(
    ...
    preconditioner_update_probability: Union[float, Callable[[int], float]] = precond_update_prob_schedule(),
    ...
    def init_fn(params, return_partition_specs_only=False):
        ...
        if not return_partition_specs_only:
            ...
            if jax.process_index() == 0:
                print(f"PSGD Preconditioners size: {Qs_n_elements} elements, " f"{Qs_size_MB:.2f} MB")
            if mu is not None:
